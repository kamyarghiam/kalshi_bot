...
resource "aws_iam_policy" "features_raw_source_rw" {
  ...
  policy = jsonencode({
    ...
    Statement = [
      {
        Action = [
          "s3:PutObject", "s3:GetObject", "s3:DeleteObject", "s3:HeadObject", "s3:ListObjectsV2", "s3:ListObjects"
        ]
        Effect   = "Allow"
...
resource "aws_iam_policy" "features_raw_all_rw" {
  ...
  policy = jsonencode({
    ...
    Statement = [
      {
        Action = [
          "s3:PutObject", "s3:GetObject", "s3:ListBucket", "s3:DeleteObject", "s3:HeadObject", "s3:ListObjectsV2", "s3:ListObjects"
        ]
        Effect   = "Allow"
