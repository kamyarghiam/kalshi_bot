...
def compute_historical_features(
    ...
    path_to_cache = (
        LOCAL_STORAGE_FOLDER / f"historical_features/ml_ob_strat_{date_abbreviated}.csv"
    )
...
def run_ml_ob_strat_with_blind_simulator():
    ...
    for date in dates:
        ...
        strategy = MLOrderbookStrategy([m.ticker for m in kalshi_spy_markets])
        sim = BlindOrderSim(
...
if __name__ == "__main__":
    run_ml_ob_strat_with_blind_simulator()
